...
```
IP: `192.168.43.88`
![](<../../assets/Pasted image 20260112153443.png>)
### dirsearch
```bash
┌──(root㉿kali)-[~]
...
#### 查看robots.txt
发现`login`登录的 `path`
![](<../../assets/Pasted image 20260112210425.png>)
## 2.页面
点击`Who we Are` 发现`nid=2`, 推测是否有注入点
![](<../../assets/Pasted image 20260112160306.png>)
尝试后面加`'`， 发现存在注入点
![](<../../assets/Pasted image 20260112160356.png>)
### sqlmap
...
![](<../../assets/Pasted image 20260112165158.png>)
可以选择`php`语言，我们思考可以`nc`反弹
![](<../../assets/Pasted image 20260112165639.png>)
```php
<?php
...
......
```
![](<../../assets/Pasted image 20260112202617.png>)

 **文件路径** : `/usr/share/exploitdb/exploits/linux/local/46996.sh`
![](<../../assets/Pasted image 20260112204519.png>)
