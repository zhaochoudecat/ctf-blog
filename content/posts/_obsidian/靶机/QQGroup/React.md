...
访问80和3000端口，无发现
![](<../../assets/Pasted image 20260107183905.png>)

![](<../../assets/Pasted image 20260107183833.png>)
## 2.漏洞
...
![](<../../assets/Pasted image 20260107222416.png>)
## 3.升级shell
```shell
┌──(zsc@kali)-[~] 
└─$ nc -lnvp 5566 
...
```
直接执行无回显，看下里面的可打印字符
![](<../../assets/Pasted image 20260107221501.png>)
