---
title: "11-admin"
description: "Flask Session 伪造 Flask session 结构：{payload}.{timestamp}.{signature}，使用 URL 安全的 base64 编码。payload 长度可变；timestamp 是 base62 编码的 Unix 时间戳（约 6 字符）；signature 固定 27 字…"
